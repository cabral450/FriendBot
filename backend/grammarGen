...
#temporary grammar but eventually sentence broken down into a grammar
	...
	for word in tokens2:
		...
		if word[1] == "RB" or word[1] == "RBR" or word[1] == "RBS" or word[1] == "VB" or word[1] == "VBG" or word[1] == "VBD" or word[1] == "VBN" or word[1] == "VBP" or word[1] == "VBZ":
			verb = word[0]
